...
//       toast.success(
//         "Account created successfully! Welcome to MapExtractor Pro. You can now log in."
//       );
...
//                       onChange={handleInputChange}
//                       required
//                       className="h-12 border-gray-200 pr-10 focus:border-[#2462f1] focus:ring-2 focus:ring-[#2462f1]  dark:focus:ring-[#2462f1]/5"
//                     />
//                     <button
//                       type="button"
...
//                     <Link
//                       to="/terms"
//                       className="text-[#2462f1] hover:underline"
//                     >
//                       Terms of Service
//                     </Link>{" "}
//                     and{" "}
...
//                 <Button
//                   type="submit"
//                   className="w-full h-12 bg-[#2462f1]  text-white"
//                   disabled={
//                     isSigningUp ||
//                     !agreeToTerms ||
//                     !passwordsMatch ||
